...
public class CharacterAnimationController : MonoBehaviour
{
    ...
    public void Hit()
    {
        ...
        t_CharacterParammanager = AttackRoot.parent.Find("Ram").GetComponent<CharacterParamManager>();
        t_CharacterParammanager.Damage(m_CharacterParamManager.CharacterAttack);
